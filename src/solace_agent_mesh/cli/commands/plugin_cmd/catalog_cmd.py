...
from solace_agent_mesh.cli.utils import error_exit, wait_for_server
...
def run_flask_plugin_catalog(host, port, shared_data):
    try:
        from solace_agent_mesh.config_portal.backend.plugin_catalog_server import (
            create_plugin_catalog_app,
        )
        from solace_agent_mesh.config_portal.backend.plugin_catalog.constants import (
